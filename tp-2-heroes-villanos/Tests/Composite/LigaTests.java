...
public class LigaTests {
	...
	@Test
	public void testEliminarLigaAnidada()
			throws AddToLeagueException, DeleteCompetitorException, FeatureLevelException {
	...
	public void testEliminarCompetidorSinLiga()
			throws AddToLeagueException, DeleteCompetitorException, FeatureLevelException {
	...
	@Test(expected = DeleteCompetitorException.class)
	public void testEliminarLigaSinLigaAnidada()
			throws AddToLeagueException, DeleteCompetitorException, FeatureLevelException {
	...
	@Test(expected = DeleteCompetitorException.class)
	public void testEliminarCompetidorFueraDeLiga()
			throws AddToLeagueException, DeleteCompetitorException, FeatureLevelException {
	...
	@Test(expected = DeleteCompetitorException.class)
	public void testEliminarLigaFueraDeLigaAnidada()
			throws AddToLeagueException, DeleteCompetitorException, FeatureLevelException {
	...
	@Test
	public void testLigaVsCompetidorEsGanador()
	...
	@Test
	public void testLigaVsCompetidorNoEsGanador()
			throws AddToLeagueException, FeatureLevelException, FriendlyFireException {
		Personaje p1 = new Villano("Harleen Frances Quinzel", "Harley Quinn", 50, 500, 50, 50);
		Personaje p2 = new Villano("Pamela Lillian Isley", "Hiedra Venenosa", 50, 500, 50, 50);
	...
	@Test
	public void testLigaVsCompetidorEmpateGana()
			throws AddToLeagueException, FeatureLevelException, FriendlyFireException {
		Personaje p1 = new Villano("Harleen Frances Quinzel", "Harley Quinn", 50, 500, 50, 50);
		Personaje p2 = new Villano("Pamela Lillian Isley", "Hiedra Venenosa", 50, 500, 50, 50);
	...
	@Test
	public void testLigaVsCompetidorEmpatePierde()
			throws AddToLeagueException, FeatureLevelException, FriendlyFireException {
		Personaje p1 = new Villano("Harleen Frances Quinzel", "Harley Quinn", 50, 500, 50, 50);
		Personaje p2 = new Villano("Pamela Lillian Isley", "Hiedra Venenosa", 50, 500, 50, 50);
	...
	@Test
	public void testLigaVsCompetidorEmpateFinal()
			throws AddToLeagueException, FeatureLevelException, FriendlyFireException {
		Personaje p1 = new Villano("Harleen Frances Quinzel", "Harley Quinn", 50, 500, 50, 50);
		Personaje p2 = new Villano("Pamela Lillian Isley", "Hiedra Venenosa", 50, 500, 50, 50);
	...
	public void testLigaHeroeVsLigaHeroe() throws FeatureLevelException, FriendlyFireException, AddToLeagueException {
		Personaje p1 = new Heroe("Bruno Diaz", "Batman", 100, 100, 100, 50);
		Personaje p2 = new Heroe("Clark Kent", "Superman", 100, 200, 200, 100);
		Personaje p3 = new Heroe("Arthur Curry", "Aquaman", 100, 200, 200, 100);

		Liga ligaHeroe1 = new LigaHeroe("Liga Heroe 1");
		ligaHeroe1.agregarCompetidor(p1);

		Liga ligaHeroe2 = new LigaHeroe("Liga Heroe 2");
		ligaHeroe2.agregarCompetidor(p2);
		ligaHeroe2.agregarCompetidor(p3);

		ligaHeroe1.esGanador(ligaHeroe2, new Caracteristica(2));

	}

	@Test(expected = FriendlyFireException.class)
	public void testLigaHeroeVsHeroe() throws FeatureLevelException, FriendlyFireException, AddToLeagueException {
		Personaje p1 = new Heroe("Bruno Diaz", "Batman", 100, 100, 100, 50);
		Personaje p2 = new Heroe("Clark Kent", "Superman", 100, 200, 200, 100);
		Personaje p3 = new Heroe("Arthur Curry", "Aquaman", 100, 200, 200, 100);

		Liga ligaHeroe = new LigaHeroe("Liga Heroe");
		ligaHeroe.agregarCompetidor(p2);
		ligaHeroe.agregarCompetidor(p3);

		ligaHeroe.esGanador(p1, new Caracteristica(2));

	}

	@Test(expected = FriendlyFireException.class)
	public void testLigaVillanoVsLigaVillano()
			throws FeatureLevelException, FriendlyFireException, AddToLeagueException {
		Personaje p1 = new Villano("Harleen Frances Quinzel", "Harley Quinn", 500, 350, 400, 100);
		Personaje p2 = new Villano("Pamela Lillian Isley", "Hiedra Venenosa", 150, 300, 500, 150);
		Personaje p3 = new Villano("Jack Oswald White", "Joker", 150, 300, 500, 150);

		Liga LigaVillano1 = new LigaVillano("Liga Villano 1");
		LigaVillano1.agregarCompetidor(p1);

		Liga LigaVillano2 = new LigaVillano("Liga Villano 2");
		LigaVillano2.agregarCompetidor(p2);
		LigaVillano2.agregarCompetidor(p3);

		LigaVillano1.esGanador(LigaVillano2, new Caracteristica(2));

	}

	@Test(expected = FriendlyFireException.class)
	public void testLigaVillanoVsVillano() throws FeatureLevelException, FriendlyFireException, AddToLeagueException {
		Personaje p1 = new Villano("Harleen Frances Quinzel", "Harley Quinn", 500, 350, 400, 100);
		Personaje p2 = new Villano("Pamela Lillian Isley", "Hiedra Venenosa", 150, 300, 500, 150);
		Personaje p3 = new Villano("Jack Oswald White", "Joker", 150, 300, 500, 150);

		Liga LigaVillano = new LigaVillano("Liga Villano");
		LigaVillano.agregarCompetidor(p1);
		LigaVillano.agregarCompetidor(p3);

		LigaVillano.esGanador(p2, new Caracteristica(2));
